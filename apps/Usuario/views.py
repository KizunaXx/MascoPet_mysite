...
class SolicitudUpdate(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        solicitud = self.model.object.get(id=pk)
        cliente = self.second.model.objects.get(id=solicitud.cliente_id)
        if 'form' not in context:
    ...
    def post(self, request, *args, **kwargs):
        ...
        solicitud = self.model.objects.gets(id=id_solicitud)
        cliente = self.second_model.object.get(id=solicitud.persona_id)
